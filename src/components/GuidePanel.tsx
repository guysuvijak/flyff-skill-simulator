        ...
        <>
            {guidePanelVisible && (
                <div
                    ...
                    className='flex w-screen h-screen justify-center items-center absolute z-20 bg-[#00000090]'
                >
                    <div
                        onClick={handleInnerClick}
                        className='flex flex-col justify-center items-center p-8 bg-[#FFFFFF] rounded-md z-30 shadow-lg'
                    >
                        <div className='flex flex-col items-center pb-5'>
                            <span className='flex items-center justify-center font-bold text-[18px]'>
                                <FaStar
                                    size={20}
                                    className='text-[#ffda21] mr-1 rotate-180'
                                />
                            ...
                            <ul className='space-y-1 py-2 border-y-2'>
                                ...
                                <li>
                                    • Calculate optimal skill point distribution
                                </li>
                            ...
                            <a
                                ...
                                className='flex items-center text-blue-800 hover:text-blue-900 hover:underline transition-colors'
                            >
                                <FaFacebook
                                    size={20}
